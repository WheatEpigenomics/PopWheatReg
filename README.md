# PopWheatReg
Population-scale integrative analysis of chromatin accessibility, gene expression and regulatory variation underlying spike development and agronomic traits in polyploid wheat.
...
identify accessible chromatin regions (ACRs) and quantify their population-level variation,

map chromatin accessibility QTLs (caQTLs) and expression QTLs (eQTLs),

construct local ACR–gene regulatory links (agLinks) and distal chromatin co-accessibility networks (coACRs),

integrate regulatory mapping results with GWAS, TWAS and caWAS analyses to infer causal regulatory variants,
